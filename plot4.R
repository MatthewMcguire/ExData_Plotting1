...
# set up a panel of four plots
par(mfrow = c(2, 2))

# create first line plot
plot(x=hpcSelection$DateTime, y=hpcSelection$Global_active_power, type="l", xlab="", ylab="Global Active Power (kilowatts)")

# create second line plot
plot(x=hpcSelection$DateTime, y=hpcSelection$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
# create fourth line plot
plot(x=hpcSelection$DateTime, y=hpcSelection$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
